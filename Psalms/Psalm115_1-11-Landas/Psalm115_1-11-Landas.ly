...
\header {
  ...
  title = "Psalm 115:1-11 - The Psalms of David in Metre, pg 241-242"
...
versesVoiceOne = \lyricmode {
  % Verse 1-3
  NOT un- to us, Lord, not to us,
  but do thou glo- ry take
  Un- to thy name, ev'n for thy truth,
  and for thy mer- cy's sake.
  O where- fore should the heath- en say,
  Where is their God now gone?
  But our God in the heav- ens is,
  what pleas'd him he hath done.
}

versesVoiceTwo = \lyricmode {
  % Verse 4-7
  Their i- dols sil- ver are and gold,
  ...
  no- ses, but sa- vour not;
  Hands, feet, but han- dle not, nor walk;
  nor speak they through their throat.
}

versesVoiceThree = \lyricmode {
  % Verse 8-11
  Like them their ma- kers are, and all
  on them their trust that build.
  O Is- r'el, trust thou in the Lord,
  he is their help and shield.
  O Aa- ron's house, trust in the Lord,
