...
\header {
  ...
  title = "Psalm 119:33-40 -- The Psalms of David in Metre, pg. 250-251"
...
versesVoiceThree = \lyricmode {
  % Verse 38-40
  Con- firm to me thy gra- cious word,
  which I did glad- ly hear,
  Ev'n to thy ser- vant, Lord, who is
  de- vo- ted to thy fear.
  Turn thou a- way my fear'd re- proach;
  for good thy judge- ments be.
  Lo, for thy pre- cepts I have long'd;
  in thy truth quick- en me.
  A- men
}
