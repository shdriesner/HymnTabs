...
\header {
  ...
  title = "Psalm 145:7-11 -- The Psalms of David in Metre, page 300-301"
  subtitle = "(tune: Landas - NO CAPO)"
  instrument = "Voice"
  composer = "Traditional"
  arranger = "Transposed: Stefan Driesner - October 2025"
  meter = ""
...
versesVoiceTwo = \lyricmode {
  % Verse 9-11
  The Lord JE- HO- VAH un- to all
  his good- ness doth de- clare;
  And o- ver all his oth- er works
  his ten- der mer- cies are.
  Thee all thy works shall praise, O Lord,
  and thee thy saints shall bless;
  They shall thy king- dom's glo- ry show,
  thy pow'r by speech ex- press:
  A- men
}
