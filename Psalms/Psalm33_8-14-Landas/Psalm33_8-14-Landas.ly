...
\header {
  ...
  title = "Psalm 33:8-14 -- The Psalms of David in Metre, pg. 57-58"
...
versesVoiceOne = \lyricmode {
  ...
  Let all the world's in- ha- bi- tants
  dread him with one ac- cord.
  For he did speak the word, and done
  it was with- out de- lay;
  Es- ta- blish- ed it firm- ly stood,
  what- ev- er he did say.
}
...
versesVoiceTwo = \lyricmode {
  ...
  doth stand for- ev- er sure;
  And of his heart the pur- po- ses
