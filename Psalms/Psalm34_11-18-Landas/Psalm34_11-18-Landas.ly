...
\header {
  ...
  title = "Psalm 34:11-18 -- The Psalms of David in Metre, page 60"
...
versesVoiceOne = \lyricmode {
  % Verse 11-13
  O chil- dren, hi- ther do ye come,
  and un- to me give ear;
  I shall you teach to un- der- stand
  how ye the Lord should fear.
  What man is he that life de- sires,
  to see good would live long?
  Thy lips re- frain from speak- ing guile,
  and from ill words thy tongue.
}

versesVoiceTwo = \lyricmode {
  % Verse 14-16
  De- part from ill, do good, seek peace,
  pur- sue it ear- nest- ly.
  God's eyes are on the just; his ears
  are o- pen to their cry.
  The face of God is set a- gainst
  those that do wick- ed- ly,
  That he may quite out from the earth
  cut off their mem- o- ry.
}
