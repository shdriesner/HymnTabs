...
\header {
  ...
  title = "Psalm 40:1-7 -- The Psalms of David in Metre, pg. 75-76"
...
versesVoiceFour = \lyricmode {
  % Verse 6-7
  No sac- ri- fice nor of- fer- ing
  didst thou at all de- sire;
  Mine ears thou bor'd: sin- off- 'ring thou
  and burnt didst not re- quire:
  Then to the Lord these were my words,
  I come, be- hold and see;
  With- in the vol- ume of the book
  it writ- ten is of me:
  A- men
}
