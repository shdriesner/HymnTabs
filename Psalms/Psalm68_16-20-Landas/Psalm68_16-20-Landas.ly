...
\header {
  ...
  title = "Psalm 68:16-20 -- The Psalms of David in Metre, pg. 129-130"
...
versesVoiceOne = \lyricmode {
  % Verse 16-17
  Why do ye leap, ye moun- tains high?
  this is the hill where God
  De- sires to dwell; yea, God in it
  for aye will make a- bode.
  God's char- iots twen- ty thou- sand are,
  thou- sands of an- gels strong;
  In's ho- ly place God is, as in
  mount Si- nai, them a- mong.
}

versesVoiceTwo = \lyricmode {
  % Verse 18
  Thou hast, O Lord, most glo- ri- ous,
  as- cen- ded up on high;
  And in tri- umph vic- to- rious led
  cap- tive cap- ti- vi- ty:
  Thou hast re- ceiv- ed gifts for men,
  for such as did re- bel;
...
versesVoiceThree = \lyricmode {
  ...
  of our sal- va- tion God;
  Who dai- ly with his be- ne- fits
  us plen- teous- ly doth load.
  He of sal- va- tion is the God,
  who is our God most strong;
  And un- to God the Lord from death
  the is- sues do be- long.
  A- men
}
