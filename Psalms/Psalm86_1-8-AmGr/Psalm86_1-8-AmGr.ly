...
\header {
  ...
  title = "Psalm 86:1-8 - The Psalms of David in Metre, pg 174-175"
...
versesVoiceOne = \lyricmode {
  ...
  and hear me gra- cious- ly;
  Be- cause I sore af- fli- cted am,
  and am in po- ver- ty
}

versesVoiceTwo = \lyricmode {
  % Verse 2
  Be- cause I'm ho- ly, let my soul
  by thee pre- ser- ved be.
  O thou my God, thy ser- vant save,
  that puts his trust in thee.
}

versesVoiceThree = \lyricmode {
  % Verse 3-4
  Sith un- to thee I dai- ly cry,
  be mer- ci- ful to me.
  Re- joice thy ser- vant's soul; for, Lord,
  I lift my soul to thee.
}

versesVoiceFour = \lyricmode {
  % Verse 5
  For thou art gra- - cious, O Lord,
  and read- y to for- give;
  And rich in mer- cy, all that call
  up- on thee to re- lieve.
}
