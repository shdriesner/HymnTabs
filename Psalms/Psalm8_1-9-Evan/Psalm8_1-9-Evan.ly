...
\header {
  ...
  title = "Psalm 8:1-9 -- The Psalms of David in Metre, pg. 10-11"
...
versesVoiceFive = \lyricmode {
  % Verse 5
  For thou a lit- tle low- er hast
  him than the an- gels made;
  With glo- ry and with dig- ni- ty
  thou crown- ed hast his head.
}

versesVoiceSix = \lyricmode {
  % Verse 6-7
  Of thy hands' works thou mad'st him lord,
  all un- der's feet didst lay;
  All sheep and ox- en, yea, and beasts
