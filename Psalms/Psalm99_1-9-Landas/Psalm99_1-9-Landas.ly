...
\header {
  ...
  title = "Psalm 99:1-9 - The Psalms of David in Metre, pg 200-201"
...
versesVoiceThree = \lyricmode {
  % Verse 6-7
  Mo- ses and Aa- ron 'mong his priests,
  Sam- uel, with them that call
  Up- on his name: these call'd on God,
  and he them an- swer'd all.
  With- in the pil- lar of the cloud
  he un- to them did speak:
  The tes- ti- mo- nies he them taught,
  and laws, they did not break.
}

versesVoiceFour = \lyricmode {
  % Verse 8-9
  Thou an- swer'dst them, O Lord, our God;
  thou wast a God that gave
  Par- don to them, though on their deeds
  thou would- est ven- geance have.
  Do ye ex- alt the Lord our God,
  and at his ho- ly hill
  Do ye him wor- ship: for the Lord
  our God is ho- ly still.
  A- men.
}
